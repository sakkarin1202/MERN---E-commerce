  ...
  return (
    <div className="section-container my-20 relative">
      ...
      <div className="md:absolute right-3 top-8 mb-10 md:mr-24 space-x-2">
        <button className='btn bg-red p-2 rounded-full h-15 w-20 mt-5 text-white'onClick={()=>slider?.current?.slickPrev()}>&lt;</button>
        <button className='btn bg-red p-2 rounded-full h-15 w-20 mt-5 text-white'onClick={()=>slider?.current?.slickNext()}>&gt;</button>
      </div>
